...
function updateBagItem() {
    ...
    .then(data => {
        ...
        obj_mp3.play();        
      	debugger;
        document.querySelector('.packabag-sidebar__bag').add('animated tada');
        setTimeout(function(){ document.querySelector('.packabag-sidebar__bag').remove('animated tada') }, 1000); 
    });
}
